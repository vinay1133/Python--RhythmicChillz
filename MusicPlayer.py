...
#=PhotoImage(file="C:\\Users\\Snehal\\Downloads\\Python mini project\\images\\top.png")
#Label(root,image=Top, bg="#0f1a2b").pack()

#Logo
#Logo=PhotoImage(file="C:\\Users\\Snehal\\Downloads\\Python mini project\\images\\logo.png")
...
Button(root,text="Open Folder",width=15,height=2,font=("Sans Serif",12,"bold"),fg="white",bg="#D77337",command=open_folder).place(x=620,y=135)
